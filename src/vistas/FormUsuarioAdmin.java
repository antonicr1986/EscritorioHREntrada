...
public class FormUsuarioAdmin extends javax.swing.JFrame {
    ...
    public void setjLabel1(String nuevoTexto) {
        jLabelAdminCode.setText(nuevoTexto);
    }
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        try {
            ...
            String codigoUserRecibido = jLabelAdminCode.getText(); //el codigo recibido tiene que ser el mismo que le hemos asignado
            ...
            String palabra = codigoUserRecibido + "," + crud + "," + nombreTabla + "," + columna + "," + palabraAbuscar + "," + orden;
            
            
            switch (crud){
                case "select":
                    crud = "0";
                    System.out.println("Crud es: "+crud);
                    break;
                case "insert":
                    crud = "1";
                    System.out.println("Crud es: "+crud);
